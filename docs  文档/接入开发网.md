...
```
Ethereum compatible: https://devnet2openapi.platon.network/rpc or wss://devnet2openapi.platon.network/ws
Ethereum imcompatible: https://devnet2openapi2.platon.network/rpc
```
